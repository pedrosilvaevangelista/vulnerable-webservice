...
If you already have [Docker Desktop](https://www.docker.com/products/docker-desktop/) installed and running, simply run the following command in the project root:
